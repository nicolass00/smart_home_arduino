...
public class frmconfigcomandos extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    private static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("ExControl.Domotica", "ExControl.Domotica.frmconfigcomandos", this);
            if (htSubs == null) {
            ...
            if (ba.getClass().getName().endsWith("ShellBA")) {
			    ba.raiseEvent2(null, true, "CREATE", true, "ExControl.Domotica.frmconfigcomandos",
                    ba);
		    }
        }
...
_i = 0;
 //BA.debugLineNum = 108;BA.debugLine="For i =0 To ValoresComunes.Comandos  .Size -1";
{
final int step76 = 1;
final int limit76 = (int) (_valorescomunes._comandos.getSize()-1);
...
_c = new ExControl.Domotica.valorescomunes._scene();
 //BA.debugLineNum = 110;BA.debugLine="C = ValoresComunes.ComandoS.Get (i)";
_c = (ExControl.Domotica.valorescomunes._scene)(_valorescomunes._comandos.Get(_i));
...
_co.descripcion = _inb._val;
 //BA.debugLineNum = 56;BA.debugLine="ValoresComunes.Comandos.Add (co)";
_valorescomunes._comandos.Add((Object)(_co));
 //BA.debugLineNum = 58;BA.debugLine="ValoresComunes.GuardaComandos";
_valorescomunes._guardacomandos();
...
_co = new ExControl.Domotica.valorescomunes._scene();
 //BA.debugLineNum = 122;BA.debugLine="co = ValoresComunes.Comandos.Get (Index)";
_co = (ExControl.Domotica.valorescomunes._scene)(_valorescomunes._comandos.Get(_index));
...
_co.descripcion = _inb._description;
 //BA.debugLineNum = 131;BA.debugLine="ValoresComunes.GuardaComandos";
_valorescomunes._guardacomandos();
